...
RUN chown -R 0:0 /etc/apache2/vhost.d /config /run/apache2 /var/log/apache2 /application/joomla/ /var/log/
RUN chmod -R 775 /etc/apache2/vhost.d /config /run/apache2 /var/log/apache2 /application/joomla/ /var/log/
